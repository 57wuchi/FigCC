...
- Hot pink: `{ r: 1, g: 0.08, b: 0.58 }` — `#FF1493`
- Baby pink: `{ r: 1, g: 0.71, b: 0.76 }` — `#FFB6C1`
- Deep pink: `{ r: 0.86, g: 0.08, b: 0.24 }` — `#DC143C` (but pinker)
- Bubblegum: `{ r: 1, g: 0.44, b: 0.71 }` — `#FF70B5`
- Blush: `{ r: 1, g: 0.89, b: 0.93 }` — `#FFE4EE`
